...
upgrades_table: Dict[str, RabiRibiItemData] = {
    ...
    "Easter Egg"        : RabiRibiItemData(rabi_ribi_base_id + 0x08, ItemClassification.progression),
    ...
    "Piko Hammer"       : RabiRibiItemData(rabi_ribi_base_id + 0x0F, ItemClassification.progression),
    "Quick Barrette"    : RabiRibiItemData(rabi_ribi_base_id + 0x10, ItemClassification.filler),
    "Plus Necklace"     : RabiRibiItemData(rabi_ribi_base_id + 0x11, ItemClassification.filler),
    "Rabi Slippers"     : RabiRibiItemData(rabi_ribi_base_id + 0x12, ItemClassification.progression),
    "Sliding Powder"    : RabiRibiItemData(rabi_ribi_base_id + 0x13, ItemClassification.progression),
    "Speed Boost"       : RabiRibiItemData(rabi_ribi_base_id + 0x14, ItemClassification.progression),
    "Spike Barrier"     : RabiRibiItemData(rabi_ribi_base_id + 0x15, ItemClassification.filler),
    "Super Carrot"      : RabiRibiItemData(rabi_ribi_base_id + 0x16, ItemClassification.filler),
    "Wall Jump"         : RabiRibiItemData(rabi_ribi_base_id + 0x17, ItemClassification.progression),
    "Water Orb"         : RabiRibiItemData(rabi_ribi_base_id + 0x18, ItemClassification.progression)
}

magic_table: Dict[str, RabiRibiItemData] = {
    "Carrot Shooter"    : RabiRibiItemData(rabi_ribi_base_id + 0x19, ItemClassification.progression),
    "Chaos Rod"         : RabiRibiItemData(rabi_ribi_base_id + 0x1A, ItemClassification.progression_skip_balancing),
    "Explode Shot"      : RabiRibiItemData(rabi_ribi_base_id + 0x1B, ItemClassification.progression_skip_balancing),
    "Sunny Beam"        : RabiRibiItemData(rabi_ribi_base_id + 0x1C, ItemClassification.progression_skip_balancing)
}

badges_table: Dict[str, RabiRibiItemData] = {
    "Arm Strength"      : RabiRibiItemData(rabi_ribi_base_id + 0x1D, ItemClassification.filler),
    "Armored"           : RabiRibiItemData(rabi_ribi_base_id + 0x1E, ItemClassification.filler),
    "Atk Grow"          : RabiRibiItemData(rabi_ribi_base_id + 0x1F, ItemClassification.filler),
    "Atk Trade"         : RabiRibiItemData(rabi_ribi_base_id + 0x20, ItemClassification.filler),
    "Auto Trigger"      : RabiRibiItemData(rabi_ribi_base_id + 0x21, ItemClassification.filler),
    "Blessed"           : RabiRibiItemData(rabi_ribi_base_id + 0x22, ItemClassification.filler),
    "Carrot Boost"      : RabiRibiItemData(rabi_ribi_base_id + 0x23, ItemClassification.filler),
    "Cashback"          : RabiRibiItemData(rabi_ribi_base_id + 0x24, ItemClassification.filler),
    "Crisis Boost"      : RabiRibiItemData(rabi_ribi_base_id + 0x25, ItemClassification.filler),
    "Def Grow"          : RabiRibiItemData(rabi_ribi_base_id + 0x26, ItemClassification.filler),
    "Def Trade"         : RabiRibiItemData(rabi_ribi_base_id + 0x27, ItemClassification.filler),
    "Erina Badge"       : RabiRibiItemData(rabi_ribi_base_id + 0x28, ItemClassification.filler),
    "Frame Cancel"      : RabiRibiItemData(rabi_ribi_base_id + 0x29, ItemClassification.filler),
    "Health Plus"       : RabiRibiItemData(rabi_ribi_base_id + 0x2A, ItemClassification.filler),
    "Health Surge"      : RabiRibiItemData(rabi_ribi_base_id + 0x2B, ItemClassification.filler),
    "Health Wager"      : RabiRibiItemData(rabi_ribi_base_id + 0x2C, ItemClassification.filler),
    "Hex Cancel"        : RabiRibiItemData(rabi_ribi_base_id + 0x2D, ItemClassification.filler),
    "Hitbox Down"       : RabiRibiItemData(rabi_ribi_base_id + 0x2E, ItemClassification.filler),
    "Lucky Seven"       : RabiRibiItemData(rabi_ribi_base_id + 0x2F, ItemClassification.filler),
    "Mana Plus"         : RabiRibiItemData(rabi_ribi_base_id + 0x30, ItemClassification.filler),
    "Mana Surge"        : RabiRibiItemData(rabi_ribi_base_id + 0x31, ItemClassification.filler),
    "Mana Wager"        : RabiRibiItemData(rabi_ribi_base_id + 0x32, ItemClassification.filler),
    "Pure Love"         : RabiRibiItemData(rabi_ribi_base_id + 0x33, ItemClassification.filler),
    "Ribbon Badge"      : RabiRibiItemData(rabi_ribi_base_id + 0x34, ItemClassification.filler),
    "Self Defense"      : RabiRibiItemData(rabi_ribi_base_id + 0x35, ItemClassification.filler),
    "Stamina Plus"      : RabiRibiItemData(rabi_ribi_base_id + 0x36, ItemClassification.filler),
    "Survival"          : RabiRibiItemData(rabi_ribi_base_id + 0x37, ItemClassification.filler),
    "Top Form"          : RabiRibiItemData(rabi_ribi_base_id + 0x38, ItemClassification.filler),
    "Tough Skin"        : RabiRibiItemData(rabi_ribi_base_id + 0x39, ItemClassification.filler),
    "Toxic Strike"      : RabiRibiItemData(rabi_ribi_base_id + 0x3A, ItemClassification.filler),
    "Weaken"            : RabiRibiItemData(rabi_ribi_base_id + 0x3B, ItemClassification.filler)
}

collectables_table: Dict[str, RabiRibiItemData] = {
    "Attack Up"         : RabiRibiItemData(rabi_ribi_base_id + 0x3C, ItemClassification.filler),
    "Cyber Flower"      : RabiRibiItemData(rabi_ribi_base_id + 0x3D, ItemClassification.filler),
    ...
    "P Hairpin"         : RabiRibiItemData(rabi_ribi_base_id + 0x43, ItemClassification.filler),
    "Pack Up"           : RabiRibiItemData(rabi_ribi_base_id + 0x44, ItemClassification.filler),
    "Regen Up"          : RabiRibiItemData(rabi_ribi_base_id + 0x45, ItemClassification.filler)
}
