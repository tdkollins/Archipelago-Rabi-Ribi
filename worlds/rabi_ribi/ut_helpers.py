...
poptracker_name_mapping: dict[str, int] = {
    ...
    "Ribbon Badge/Ribbon Badge"             : rabi_ribi_base_id + 0xD2,
    "Erina Badge/Erina Badge"               : rabi_ribi_base_id + 0xD3,
    ...
    "Egg Halloween Left Pillar/Egg"         : rabi_ribi_base_id + 0xDA,
    "Egg Halloween Right Pillar/Egg"        : rabi_ribi_base_id + 0xDB,
